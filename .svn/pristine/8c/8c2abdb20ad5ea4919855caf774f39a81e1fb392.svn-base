...
- (void)drawRect:(CGRect)rect
{
    ...
    {
        //计算文字的size
        CGSize labelSize =[_labelText boundingRectWithSize:CGSizeMake(JDTipTitleMaxWidth,1000) options:NSStringDrawingUsesLineFragmentOrigin attributes:@{NSFontAttributeName:[UIFont systemFontOfSize:14]} context:nil].size;
