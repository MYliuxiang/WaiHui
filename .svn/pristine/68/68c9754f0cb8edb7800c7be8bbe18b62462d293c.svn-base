...
- (void)setupTitleLabel:(NSString *)titleStr{
    ...
    self.titleLabel.frame = CGRectMake(0, contentHeight + subViweMargin + self.imageMargin, width, fontSize);
...
- (void)setupDetailLabel:(NSString *)detailStr{
    ...
    self.detailLabel.frame = CGRectMake(0, contentHeight + subViweMargin + self.titleMargin, width, height);
...
- (void)setupActionBtn:(NSString *)btnTitle target:(id)target action:(SEL)action btnClickBlock:(LYActionTapBlock)btnClickBlock{
    ...
    self.actionButton.frame = CGRectMake(0, contentHeight + subViweMargin + self.detailMargin, btnWidth, btnHeight);
