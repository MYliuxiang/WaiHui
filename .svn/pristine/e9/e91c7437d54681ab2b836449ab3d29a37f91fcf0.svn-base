...
#import "LotCountCell.h"

@implementation LotCountCell
...
- (void)awakeFromNib {
    ...
    self.btn4.layer.cornerRadius = 8.5;
    self.btn4.backgroundColor = [UIColor whiteColor];
    self.btn4.layer.borderColor = [MyColor colorWithHexString:@"#E3E3F6"].CGColor;
    self.btn4.layer.borderWidth = 1;
    
    self.btn5.layer.masksToBounds = YES;
    self.btn5.layer.cornerRadius = 8.5;
    self.btn5.backgroundColor = [UIColor whiteColor];
    self.btn5.layer.borderColor = [MyColor colorWithHexString:@"#E3E3F6"].CGColor;
...
- (IBAction)btnAC:(id)sender {
    ...
    switch (index) {
        case 0:
        {
            ...
            self.btn5.layer.borderColor = [MyColor colorWithHexString:@"#E3E3F6"].CGColor;
            self.btn5.layer.borderWidth = 1;
            self.countView.currentCount = @"0.1";
        ...
        case 1:
        {
            ...
            self.btn5.layer.borderColor = [MyColor colorWithHexString:@"#E3E3F6"].CGColor;
            self.btn5.layer.borderWidth = 1;
            self.countView.currentCount = @"0.2";
        ...
        case 2:
        {
            ...
            self.btn5.layer.borderColor = [MyColor colorWithHexString:@"#E3E3F6"].CGColor;
            self.btn5.layer.borderWidth = 1;
            self.countView.currentCount = @"0.5";
        ...
        case 3:
        {
            self.btn4.layer.masksToBounds = YES;
            self.btn4.layer.cornerRadius = 8.5;
            self.btn4.backgroundColor = [MyColor colorWithHexString:@"#E3E3F6"];
            self.btn4.layer.borderColor = [MyColor colorWithHexString:@"#E3E3F6"].CGColor;
            self.btn4.layer.borderWidth = 0;
        ...
        case 4:{
            self.btn5.layer.masksToBounds = YES;
            self.btn5.layer.cornerRadius = 8.5;
            self.btn5.backgroundColor = [MyColor colorWithHexString:@"#E3E3F6"];
            self.btn5.layer.borderColor = [MyColor colorWithHexString:@"#E3E3F6"].CGColor;
            self.btn5.layer.borderWidth = 0;
