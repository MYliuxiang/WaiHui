...
- (id) initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        UIButton *delectButton = [[UIButton alloc]initWithFrame:CGRectMake(self.frame.size.width - 65 - 15 , (self.frame.size.height - 30.0f / 2), 65, 30)];
        [delectButton setTitleColor:[MyColor colorWithHexString:@"#3D478B"] forState:UIControlStateNormal];
//        [delectButton setContentEdgeInsets:UIEdgeInsetsMake(0, 35, 0, 0)];
        ...
        [delectButton setTitle:@"全部清除" forState:UIControlStateNormal];
