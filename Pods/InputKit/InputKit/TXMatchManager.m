...
#define LXLimitedTextFieldTypePriceRegExContentFormat(limitedSuffix) [NSString stringWithFormat:@"^\\d{0,}$|^(\\d{0,}[.][0-9]{0,%ld})$",limitedSuffix]
...
+ (BOOL)matchLimitedTextTypePriceWithComponent:(id)component value:(NSString *)matchStr {
    ...
    if (limitedPrefix == NSIntegerMax) {
        matchValue = [NSPredicate predicateWithFormat:TXRegExHeader,LXLimitedTextFieldTypePriceRegExContentFormat((long)limitedSuffix)];
    }
